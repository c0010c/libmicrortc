...
- Wave 4 *(gap closure; blocked on Wave 3 execution result)*: `.planning/phases/06-chrome-e2e/06-07-PLAN.md` — Planned. 补齐真实 Chrome ICE/STUN、OpenSSL DTLS、usrsctp/DCEP DataChannel packet path，使严格 transport smoke 通过。
...
- 06-03 的 C 内部 connected/DataChannel open 诊断不能作为 Chrome 互通成功；06-07 严格 transport smoke 通过前不得执行 06-04 媒体断言。
