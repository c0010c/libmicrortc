...
| 06-07-01 | 07 | 4 | E2E-03, E2E-04, E2E-05, TEST-02, TEST-04 | T-07-01 | strict Chrome transport uses real ICE/DTLS/SCTP path | e2e | `MRTC_E2E_REQUIRE_TRANSPORT=1 MRTC_E2E_BROWSER_CHANNEL=chromium npm --prefix tests/e2e run test:host -- --grep "transport smoke"` | W0 | pending |
| 06-08-01 | 08 | 4 | E2E-03, E2E-04, E2E-05, TEST-02, TEST-04 | T-08-01 | strict Chrome transport gates on real OpenSSL/libsrtp/usrsctp DTLS/SCTP packet path | e2e | `MRTC_E2E_REQUIRE_TRANSPORT=1 MRTC_E2E_BROWSER_CHANNEL=chromium npm --prefix tests/e2e run test:host -- --grep "transport smoke"` | W0 | passed |
| 06-04-01 | 04 | 5 | E2E-04, E2E-05, E2E-06, E2E-07, E2E-08 | T-04-01 | browser stats use stable deltas after strict transport passes | e2e | `MRTC_E2E_REQUIRE_TRANSPORT=1 MRTC_E2E_BROWSER_CHANNEL=chromium npm --prefix tests/e2e run test:host -- --project=chrome-host --grep "host Chrome E2E"` | W0 | passed |
| 06-05-01 | 05 | 6 | NET-04 | T-05-01 | missing TURN config hard-fails | e2e | `npm --prefix tests/e2e run test:turn -- --turn-config ./mrtc-ice-servers.local.json` | W0 | pending |
| 06-05-02 | 05 | 6 | NET-04, E2E-05, E2E-06, E2E-07, E2E-08 | T-05-02 | relay selected path is proven | e2e | relay-only Playwright spec | W0 | pending |
| 06-06-01 | 06 | 7 | TEST-01, TEST-02, TEST-03, TEST-04 | T-06-01 | v1 script reports stage failures | cli | `scripts/verify-v1.sh` | W0 | pending |
