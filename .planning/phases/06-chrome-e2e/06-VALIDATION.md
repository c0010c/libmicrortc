...
| 06-08-01 | 08 | 4 | E2E-03, E2E-04, E2E-05, TEST-02, TEST-04 | T-08-01 | strict Chrome transport gates on real OpenSSL/libsrtp/usrsctp DTLS/SCTP packet path | e2e | `MRTC_E2E_REQUIRE_TRANSPORT=1 MRTC_E2E_BROWSER_CHANNEL=chromium npm --prefix tests/e2e run test:host -- --grep "transport smoke"` | W0 | pending |
| 06-04-01 | 04 | 5 | E2E-04, E2E-05, E2E-06, E2E-07, E2E-08 | T-04-01 | browser stats use stable deltas after strict transport passes | e2e | `npm --prefix tests/e2e run test:host` | W0 | pending |
