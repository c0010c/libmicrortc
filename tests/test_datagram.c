...
static int test_receive_chrome_binding_request_drives_ice_connected(void)
{
    unsigned char arena[16384];
    uint8_t request[160];
    ...
    RTC_TEST_EQ_INT(RTC_STATUS_OK,
                    rtc_peer_connection_receive_datagram(pc, request,
                                                         request_len));
    RTC_TEST_EQ_INT(RTC_STATUS_OK,
...
int rtc_test_datagram(void)
{
    ...
    RTC_TEST_EQ_INT(0, test_receive_chrome_binding_request_drives_ice_connected());
    return 0;
}
