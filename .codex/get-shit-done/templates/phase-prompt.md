...
<!-- For checkpoint task examples and patterns, see @/home/qs/dev/libmicrortc/.codex/get-shit-done/references/checkpoints.md -->
...
See `/home/qs/dev/libmicrortc/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/qs/dev/libmicrortc/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/qs/dev/libmicrortc/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
