...
<required_reading>
@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/ai-frameworks.md
@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/qs/dev/libmicrortc/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/qs/dev/libmicrortc/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/qs/dev/libmicrortc/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/qs/dev/libmicrortc/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/qs/dev/libmicrortc/.codex/agents/gsd-eval-planner.md for instructions.
