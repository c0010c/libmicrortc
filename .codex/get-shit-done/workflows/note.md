...
- **Global scope**: `/home/qs/dev/libmicrortc/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/qs/dev/libmicrortc/.codex/notes/`)
...
2. Glob `/home/qs/dev/libmicrortc/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/qs/dev/libmicrortc/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/qs/dev/libmicrortc/.codex/notes/` — works in any directory
