...
```
Agent(
  prompt="Read /home/qs/dev/libmicrortc/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/qs/dev/libmicrortc/.codex/get-shit-done/templates/SECURITY.md`
