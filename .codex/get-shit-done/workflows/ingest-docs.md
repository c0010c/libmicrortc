...
```bash
INIT=$(node "/home/qs/dev/libmicrortc/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/qs/dev/libmicrortc/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
