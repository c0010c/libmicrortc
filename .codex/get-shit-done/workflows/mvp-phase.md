...
<required_reading>
@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/user-story-template.md
@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/spidr-splitting.md
@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/spidr-splitting.md`. Briefly:
