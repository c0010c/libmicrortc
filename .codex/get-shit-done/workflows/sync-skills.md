...
INSTALL_JS_GLOBAL="/home/qs/dev/libmicrortc/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/qs/dev/libmicrortc/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
