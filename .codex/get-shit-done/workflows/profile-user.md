...
Key references:
- @/home/qs/dev/libmicrortc/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @/home/qs/dev/libmicrortc/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/qs/dev/libmicrortc/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/qs/dev/libmicrortc/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/qs/dev/libmicrortc/.codex/get-shit-done/USER-PROFILE.md" "/home/qs/dev/libmicrortc/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/qs/dev/libmicrortc/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/qs/dev/libmicrortc/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @/home/qs/dev/libmicrortc/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/qs/dev/libmicrortc/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/qs/dev/libmicrortc/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/qs/dev/libmicrortc/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at /home/qs/dev/libmicrortc/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/qs/dev/libmicrortc/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="/home/qs/dev/libmicrortc/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    /home/qs/dev/libmicrortc/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   /home/qs/dev/libmicrortc/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /home/qs/dev/libmicrortc/.codex/AGENTS.md
```
