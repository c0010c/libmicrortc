...
```bash
INIT=$(node "/home/qs/dev/libmicrortc/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/qs/dev/libmicrortc/.codex/get-shit-done/templates/spec.md.
