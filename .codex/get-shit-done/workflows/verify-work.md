...
<template>
@/home/qs/dev/libmicrortc/.codex/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/qs/dev/libmicrortc/.codex/get-shit-done/workflows/transition.md`.
...
- Follow @/home/qs/dev/libmicrortc/.codex/get-shit-done/workflows/diagnose-issues.md
