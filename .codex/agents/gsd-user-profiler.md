...
<reference>
@/home/qs/dev/libmicrortc/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/qs/dev/libmicrortc/.codex/get-shit-done/references/user-profiling.md` to load:
